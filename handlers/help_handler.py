...
async def help_command(update: Update, context: CallbackContext) -> None:
    help_text = (
        ...
        "/cpu - Get CPU usage\n\n"
        "✂️ /crop x y w h — Установить область кропа\n"
        "🔄 /cropreset — Сбросить кроп к полному сенсору\n"
        "📊 /cropstatus — Показать текущие настройки кропа\n"
        "/disk - Get disk usage\n\n"
        "/exec <command> - Execute a command\n\n"
        "/gigachat - Check GigaChat\n\n"
        "/gpio - Get GPIO status\n\n"
        "🔲 /grid on|off — Включить/выключить сетку на изображении\n\n"
        ...
        "/ping - Ping a host\n\n"
        "📹 /preview <on|off> — Включить/выключить отправку превью в канал\n\n"
        "/ram - Get RAM usage\n\n"
