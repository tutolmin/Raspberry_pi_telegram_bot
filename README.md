...
pi@brat:~/Raspberry_pi_telegram_bot $ cat ~/.config/systemd/user/iperf3-server.service 
```
[Unit]
Description=iPerf3 TLS Server
After=network.target

[Service]
Type=simple
WorkingDirectory=/home/pi/iperf3
ExecStart=/usr/bin/iperf3 \
    -4s \
    --rsa-private-key-path /home/pi/iperf3/private_not_protected.pem \
    --authorized-users-path /home/pi/iperf3/credentials.csv
